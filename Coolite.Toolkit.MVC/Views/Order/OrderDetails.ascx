        ...
        <Body>
            <ext:RowLayout ID="odRowLayout1" runat="server">
                ...
                <ext:LayoutRow RowHeight="1">
                    <ext:TabPanel ID="odTabPanel1" runat="server" LayoutOnTabChange="true" DeferredRender="false" Border="false">
                        <Tabs>
                            <ext:Tab ID="tabOrderDetails" runat="server" Title="Products">
                                <Body>
                            ...
                            <ext:Tab ID="tabShippingDetails" runat="server" Title="Shipping" BodyStyle="padding:5px;">
                                <Body>

...
<ext:AccordionLayout ID="wmAccordion1" runat="server" Animate="true">
    <Items>
        <ext:MenuPanel ID="acReports" runat="server" Border="false" SaveSelection="false"
            Cls="white-menu" Collapsed="true" Title="Reports">
            <Menu>
                <Items>
                    <ext:MenuItem ID="mnCustomerAddressBook" runat="server" Text="Customer Address Book"
                        Icon="Report">
                        <CustomConfig>
        ...
        <ext:MenuPanel ID="acCustomers" runat="server" Collapsed="true" Title="Customers & Orders"
        ...
        <ext:MenuPanel ID="wmPanel2" runat="server" Collapsed="true" Title="Inventory & Purchasing"
            Border="false" SaveSelection="false" Cls="white-menu">
            <Menu>
                <Items>
        ...
        <ext:MenuPanel ID="wmPanel3" runat="server" Collapsed="true" Title="Suppliers" Border="false"
        ...
        <ext:MenuPanel ID="wmPanel4" runat="server" Collapsed="true" Title="Shippers" Border="false"
            SaveSelection="false" Cls="white-menu">
            <Menu>
                <Items>
                    <ext:MenuItem runat="server" Text="Coming Soon" Icon="ApplicationForm" />
        ...
        <ext:MenuPanel ID="wmPanel6" runat="server" Collapsed="true" Title="Employees" Border="false"
            SaveSelection="false" Cls="white-menu">
            <Menu>
                <Items>
                    <ext:MenuItem runat="server" Text="Coming Soon" Icon="ApplicationForm" />

...
<head runat="server">
    <title>Northwind Traders - Sample web application using the Ext.Net Toolkit, ExtJS and ASP.NET MVC</title>    
    <style type="text/css">
        h1 {
...
<body>
    ...
    <h2>Powered by the <a href="http://www.ext.net/">Ext.Net Toolkit</a>, <a href="http://www.extjs.com/">ExtJS</a> and <a href="http://www.asp.net/mvc/">ASP.NET MVC</a></h2>
    <ext:Window 
        ID="LoginWindow"
        runat="server" 
        Closable="false"
